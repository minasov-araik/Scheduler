...
class Publish extends CronJobCommand {
    ...
    protected function publishConfig()
    {
        ...
        $content = str_replace('namespace Libraries\CronJob\Config', "namespace Config", $content);
        $content = str_replace('extends BaseConfig', "extends \Libraries\CronJob\Config\CronJob", $content);
    ...
    {
        $this->sourcePath = realpath(__DIR__ . '/cronjob/');
